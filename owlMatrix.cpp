...
class storage{
    ...
    std::string dataHeader = "Stored data:\n";
    ...
    std::string gorizontal = "______________\n";
    ...
    storage(){
        ...
        do {
            ...
            else if (approved) approved = (size == tempo.size());
    ...
    void showData(){
        ...
        for (i=0; i<size; i++){
            for (j=0; j<data[i].size(); j++) std::cout << data[i][j];
